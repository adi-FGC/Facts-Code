  ...
  return () => {
    ...
    if (fromAnalyzer.length === 0 && fromDocs.length === 0) {
      return (
        <div mix={page}>
          <p mix={empty}>
            No features detected. The analyzer found no capabilities, and no doc has a "Features" /
    ...
    return (
      <div mix={page}>
        ...
        <p mix={lede}>
          Capabilities the analyzer inferred from the code, alongside the features the docs claim.
          Mismatches are worth a look.
        </p>
